 ...
 * @author Neil Griffin
 */
public class CdiOsgiFilterInvoker implements ActionFilter, EventFilter,
	HeaderFilter, RenderFilter, ResourceFilter {

	public CdiOsgiFilterInvoker(Class<?> beanClass, BeanManager beanManager) {
	...
	public void doFilter(
		...
		invokeMethod(
			_doFilterActionMethod, actionRequest, actionResponse, filterChain);
	}
	...
	public void doFilter(
			...
			HeaderFilterChain headerFilterChain) throws IOException,
		PortletException {
	...
	public void doFilter(
		...
		invokeMethod(
			_doFilterRenderMethod, renderRequest, renderResponse, filterChain);
	}
